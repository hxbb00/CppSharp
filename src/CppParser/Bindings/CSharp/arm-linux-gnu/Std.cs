...
namespace Std
{
    namespace BasicString
    {
        ...
        public unsafe partial struct __Internal
        {
            ...
            internal static extern __IntPtr dtorc__N_std_S_basic_string__C___N_std_S_char_traits__C___N_std_S_allocator__C(__IntPtr __instance);
        }
    ...
    public unsafe partial class BasicString<_CharT, _Traits, _Alloc> : IDisposable
    {
        ...
        public static BasicString<_CharT, _Traits, _Alloc> __CreateInstance(global::Std.BasicString.__Internal native, bool skipVTables = false)
        {
            return new BasicString<_CharT, _Traits, _Alloc>(native, skipVTables);
        }

        public static void* __CopyValue(global::Std.BasicString.__Internal native)
        {
